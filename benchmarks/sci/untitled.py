...
from sci.dataverse import DataverseAPI
...
class SpaceEnv:
    ...
    def __init__(
        ...
        if ext == "csv":
            ...
            data = pd.read_csv(os.path.join(tgtdir, "synthetic_data.tab"), sep="\t", index_col=0, dtype={0: str})
        elif ext == "parquet":
        ...
        self.conf_radius = int(self.metadata["radius"]) if "nonlocal" in self.metadata["base_name"] else 0
